...
import { LayoutDashboard, Package, Settings, LogOut, FileText, Users, BarChart3, Wallet, MessageCircle, CreditCard, Building2, BellRing, WifiOff, Ticket, PieChart, Scissors, Briefcase, Handshake, PiggyBank, ClipboardCheck, FileBarChart, Warehouse, Menu, X } from 'lucide-react';
...
export default function AdminLayout() {
  ...
  const navGroups = [
    ...
    { section: 'المخزون والتصنيع', items: [
      ...
      { name: 'المخازن والتحويلات', path: '/admin/warehouses', icon: Warehouse },
